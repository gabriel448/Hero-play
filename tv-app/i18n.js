...
const I18N = {
  en: {
    ...
    'Servidor ou código': 'Server or code', 'Conferindo o servidor…': 'Checking the server…',
    'Código de servidor não encontrado.': 'Server code not found.',
    'Sem conexão para conferir o código do servidor.': 'No connection to check the server code.',
    'Usuário': 'Username', 'Senha': 'Password', 'Conectar': 'Connect',
    ...
    'Ativação expirada': 'Activation expired',
    'Este aparelho não está mais ativo': 'This device is no longer active',
    'A ativação deste aparelho venceu. Fale com quem forneceu o seu acesso para renovar — assim que renovarem, o app volta sozinho.': 'This device’s activation has ended. Contact whoever provided your access to renew — once they do, the app comes back on its own.',
    'Verificar de novo': 'Check again',
    'Ativação renovada! Carregando…': 'Activation renewed! Loading…',
  ...
  es: {
    ...
    'Servidor ou código': 'Servidor o código', 'Conferindo o servidor…': 'Comprobando el servidor…',
    'Código de servidor não encontrado.': 'Código de servidor no encontrado.',
    'Sem conexão para conferir o código do servidor.': 'Sin conexión para comprobar el código del servidor.',
    'Usuário': 'Usuario', 'Senha': 'Contraseña', 'Conectar': 'Conectar',
    ...
    'Ativação expirada': 'Activación vencida',
    'Este aparelho não está mais ativo': 'Este equipo ya no está activo',
    'A ativação deste aparelho venceu. Fale com quem forneceu o seu acesso para renovar — assim que renovarem, o app volta sozinho.': 'La activación de este equipo venció. Hable con quien le dio el acceso para renovar — en cuanto lo hagan, la app vuelve sola.',
    'Verificar de novo': 'Verificar de nuevo',
    'Ativação renovada! Carregando…': '¡Activación renovada! Cargando…',
