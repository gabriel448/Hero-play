...
(function () {
  ...
  const I18N = {
    pt: {
      ...
      'up.errcod': 'Código de servidor não encontrado.', 'up.codres': 'o código do servidor é conferido ao adicionar', 'up.serverph': 'http://host:porta ou código',
      'up.epg': 'URL do EPG (XMLTV)', 'up.epgopt': ' — opcional',
      'up.epghint': 'Deixe em branco que a gente monta a partir da sua lista.',
      'up.epgauto': '(montado a partir da lista)',
      'up.errepg': 'A URL do EPG precisa começar com http:// ou https://.',
    ...
    en: {
      ...
      'up.errcod': 'Server code not found.', 'up.codres': 'the server code is checked when you add', 'up.serverph': 'http://host:port or code',
      'up.epg': 'EPG URL (XMLTV)', 'up.epgopt': ' — optional',
      'up.epghint': 'Leave it blank and we build it from your playlist.',
      'up.epgauto': '(built from the playlist)',
      'up.errepg': 'The EPG URL must start with http:// or https://.',
